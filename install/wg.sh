...
echo -e "${Info} Wireguard VPS AutoScript by drgvpn"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/${GitUser}/i-code/main/add-user/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/${GitUser}/i-code/main/delete-user/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/${GitUser}/i-code/main/cek-user/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/${GitUser}/i-code/main/renew-user/renew-wg.sh"
wget -O wgr "https://raw.githubusercontent.com/${GitUser}/i-code/main/menu/wgr.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
